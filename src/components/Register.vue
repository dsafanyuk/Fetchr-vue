          ...
          <v-flex xs12>
            ...
            <form @keyup.enter="registerCustomer">
              ...
              <v-text-field
                ...
                required
              ></v-text-field>
              <v-alert :value="true" color="info" icon="info" outline dismissible>
                Password
                <strong>Must have at least</strong>:
                <br>8 characters
              </v-alert>
            </form>
            <div class="form-group text-center">
              <v-btn round color="#647a87" dark type="submit" @click="registerCustomer">Register</v-btn>
              <v-btn round color="#647a87" dark type="button" @click="clear">Clear</v-btn>
            </div>
            <div class="form-group text-center">
              Already have an account?
              <router-link to="/login" class="underline">Log in here</router-link>
              <br>Or
              <br>
