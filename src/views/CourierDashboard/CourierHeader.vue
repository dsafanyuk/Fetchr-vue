    ...
    <div>
      <v-toolbar dark color="primary">
        ...
        <router-link to="/dashboard">
          <img
            :src="require('../../assets/images/fetchr_header_logo.png')"
...
import CourierAcceptOrder from '../../assets/images/CourierAcceptOrder.gif';
import CourierDeliverOrder from '../../assets/images/CourierDeliverOrder.gif';
import CourierViewOrder from '../../assets/images/CourierViewOrder.gif';
